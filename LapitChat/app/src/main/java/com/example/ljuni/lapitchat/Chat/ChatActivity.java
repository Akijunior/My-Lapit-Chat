...
import com.example.ljuni.lapitchat.Adapters.GetTimeAgo;
import com.example.ljuni.lapitchat.Adapters.MessageAdapter;
...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRefreshLayout = (SwipeRefreshLayout) findViewById(R.id.sl_message);

        mMessagesList.setHasFixedSize(true);
        mMessagesList.setLayoutManager(mLinearLayout);

        mMsgAdapter = new MessageAdapter(messagesList);

        mMessagesList.setAdapter(mMsgAdapter);

        mChatToolbar = (Toolbar) findViewById(R.id.app_bar_chat);
        ...
        mRootRef.child("Users").child(mChatUser).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Picasso.with(mProfileImage.getContext()).load(image)
                        .placeholder(R.drawable.new_profile_image).into(mProfileImage);
        ...
        messageQuery.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                if (!mPrevKey.equals(messageKey)) {
                    ...
                    messagesList.add(listPosition ++, message);
                ...
                mLinearLayout.scrollToPositionWithOffset(listPosition, 0);
            ...
            mRootRef.child("Users").child(mChatUser).child("online").addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    if(!online.equals("true")){
                        ...
                        notimap.put("from", mCurrentUserId);
